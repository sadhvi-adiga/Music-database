...
<div class="col-lg-12">
	<div class="card card-outline card-success">
		...
		<button type="button" onClick="print()" class"btn btn success-wow fadeInDown"><i class="glyphicon glyphicon-print"></i>Print Report</button>
					...
					<tr>
						...
						<td class="text-center">
		                    ...
		                    <div class="dropdown-menu" style="">
		                      ...
		                      <div class="dropdown-divider"></div>
							  <button class="dropdown-item delete_user bg-dark" data-id="<?php echo $row['id'] ?>" type="button">Delete</button>
		                    </div>
						</td>
					</tr>	
				<?php endwhile; ?>
